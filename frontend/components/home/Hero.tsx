...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-white pt-24 pb-24 sm:pt-32 sm:pb-36">
      ...
      >
        <div className="h-[160px] w-[160px] sm:h-[300px] sm:w-[300px] rounded-full blur-3xl" style={{ backgroundColor: "#1D4ED8" }} />
      </motion.div>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-4 py-2 text-xs sm:text-sm font-medium text-blue-700">
        ...
        >
          <p className="text-base sm:text-lg text-slate-600 mb-4 px-2 sm:px-0">
        ...
        >
          <Button
            size="lg"
            className="h-12 sm:h-14 rounded-full px-6 sm:px-8 text-sm sm:text-base 
             bg-(--primary) 
             text-white 
